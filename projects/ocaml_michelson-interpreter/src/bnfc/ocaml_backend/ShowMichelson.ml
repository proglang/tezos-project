...
and showData (e : AbsMichelson.data) : showable = match e with
  ...
  |    AbsMichelson.DPair pair -> s2s "DPair" >> c2s ' ' >> c2s '(' >> showPair pair >> c2s ')'
  ...
  |    AbsMichelson.DMap maps -> s2s "DMap" >> c2s ' ' >> c2s '(' >> showList showMap maps >> c2s ')'
...
and showPair (e : AbsMichelson.pair) : showable = match e with
  ...
  |    AbsMichelson.DPairSeq2 (data, datas) -> s2s "DPairSeq2" >> c2s ' ' >> c2s '(' >> showData data  >> s2s ", " >>  showList showData datas >> c2s ')'
