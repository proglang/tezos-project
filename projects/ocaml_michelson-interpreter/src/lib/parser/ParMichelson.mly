...
instr : instr annotation { ANNOT ($1, $2) }
  ...
  | KW_ASSERT_SOME annotation_list { d_ASSERT_SOME $2 }
  | KW_ASSERT_LEFT annotation_list { d_ASSERT_LEFT $2 }
  | KW_ASSERT_RIGHT annotation_list { d_ASSERT_RIGHT $2 }
  ...
  | KW_MAP_CAR annotation_list SYMB2 instr_list SYMB3 { m_MAP_CAR ($2, $4) }
  | KW_MAP_CDR annotation_list SYMB2 instr_list SYMB3 { m_MAP_CDR ($2, $4) }
;
