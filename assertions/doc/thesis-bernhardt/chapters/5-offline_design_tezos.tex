...
\begin{figure}[!htb]
\subfloat[Appending assertions as separate entrypoints\label{fig:mono_eps}]{\includegraphics[width=0.5\textwidth]{figures/5-offline_tezos/pipeline_output_mono_ep_basic.jpg}}
\quad
\subfloat[Inserting the assertion code into the original entrypoint\label{fig:mono_insert}]{\includegraphics[width=0.5\textwidth]{figures/5-offline_tezos/pipeline_output_mono_basic.jpg}}
