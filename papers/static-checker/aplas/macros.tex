...
\lstdefinelanguage{michelson}{
  ...
  classoffset=1,
  morekeywords={list,nat,int,unit,string,or,pair,operation,option,address,mutez,bool, map, big_map, contract},
  keywordstyle=\color{blue},
  classoffset=2,
  morekeywords={ITER,ADD,AMOUNT,BALANCE,CAR,PAIR,CDR,COMPARE,CONS,DUP,EQ,FAILWITH,GE,IF,IF_LEFT,LE,LEFT,NIL,DROP,PAIR,PUSH,RIGHT,SENDER,SUB,UNPAIR},
...
\lstset{
  language=Caml,
  basicstyle=\ttfamily,
  morekeywords={mcontract,code,parameter,input,output,condition,pre,post,spec,requires,ensures,invariant,sender,amount,balance,storage,hash,module,contract,sig,val,paid,entrypoint,raises},
  classoffset=1,
  morekeywords={nat,int,unit,string,or,pair,option,address,bool, map, big_map, contract},
...
\newcommand{\SYSTEMINIT}{\ensuremath{SE_{init}}}
...
\newcommand{\TOPERATIONLIST}{\text{list operation}}
...
\newcommand{\KSPEC}{\lstinline{spec}}
