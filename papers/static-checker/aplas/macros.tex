...
%  basicstyle=\ttfamily,
  ...
  % predefined types
  classoffset=1,
  morekeywords={list,nat,int,unit,string,or,pair,option,address,mutez,bool, map, big_map, contract},
  keywordstyle=\color{blue},
  classoffset=2,
  morekeywords={ITER,ADD,AMOUNT,BALANCE,CAR,CDR,COMPARE,CONS,DUP,EQ,FAILWITH,GE,IF,IF_LEFT,LE,LEFT,NIL,DROP,PAIR,PUSH,RIGHT,SENDER,SUB,UNPAIR},
