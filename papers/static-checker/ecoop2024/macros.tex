...
\newcommand{\KCODE}{\text{Code}}
\newcommand{\KMCONTRACT}{\text{MContract}}
\newcommand{\KWITH}{\text{with}}
\newcommand{\KINPUT}{\text{Input}}
\newcommand{\KOUTPUT}{\text{Output}}
\newcommand{\KPRECONDI}{\text{Pre-condition}}
\newcommand{\KPOSTCONDI}{\text{Post-condition}}
\newcommand{\C}{\text{c}}
