...
Input := Pair (Pair (owner: address) (c: contract nat))
  (Pair (ledger: big_map address (pair nat (map address nat))) 
         (Pair (admin: address) 
               (Pair (paused: bool) (total_supply: nat))))
Pre-condition :=  Get_big_map (owner, ledger) = 
  Some value: option (pair nat (map address nat)) |
  value  = Pair (k: nat) (m: (map address nat))
