...
\keywords{smart contract  \and Second keyword \and Another keyword.}
\end{abstract}
%
%
%
...
contract. Once the contract is deployed, the
...
to external triggers. Closing require scheduling the invocation of a
contract at a certain time. Bidding 
requires watching the current highest bid of the contract and
