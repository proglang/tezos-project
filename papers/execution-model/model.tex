...
\begin{abstract}
  ...
  programmatic interface. We propose a typed interface for this
  purpose and establish some properties of the combined system. A
  prototype of the interface is implemented in OCaml for the Tezos
  blockchain. 
\end{abstract}
...
\begin{lstlisting}[numbers=none]
while get-state(address).flag = true and bid < limit do
    bid = bid + a;
