...
\begin{align*}
	...
	\\&\mid \PROGRAM\PROGRAM\ \mid (\PROGRAM,\PROGRAM) 	%\mid \NI \EI
...
\begin{mathpar}
  \inferrule[Node-Op]
  {
    ...
    [\PROGRAMS, \ACCOUNTS, \OPERATIONS]
    \NodeTrans
    [\PROGRAMS, \ACCOUNTS, \OP:: \OPERATIONS]
  }
  ...
  \inferrule[Node-Oph]
  {
   \\
    ...
    [\epsilon[\OP] :: \PROGRAMS, \ACCOUNTS, \OPERATIONS]
    \NodeTrans
    [\epsilon[\OPH] :: \PROGRAMS, \ACCOUNTS, \OPERATIONS]
  }
...
\begin{mathpar}
  \inferrule{
    ...
    \NodeTrans [\epsilon[\STATUSINCLUDING] ::\PROGRAMS, \ACCOUNTS, \OPERATIONS]  \| \BLOCKCHAIN}
\end{mathpar}
~\\
~\\
