...
\begin{mathpar}
  ...
  {\CHECKACC (\PUK, \ACCOUNTS)
    ...
    \NodeTrans
    [\ACCOUNTS, (\TRANSFER\NTEZ\PUK{\PUK'}\MTEZ) :: \OPERATIONS, \CONTRACTS]
  }
  ...
  {\CHECKACC (\PUK, \ACCOUNTS) \\
    ...
    [\ACCOUNTS, \OPERATIONS, \CONTRACTS]
    \NodeTrans \\
    [\ACCOUNTS, (\ORIGINATE\ID\NTEZ\PUK\CODE\STRING\MTEZ) :: \OPERATIONS, \CONTRACTS]
  }
...
\begin{mathpar}
  \inferrule[Block-Originate]{
    ...
    \Angle{[\ACCOUNTS, \OPERATIONS, \CONTRACTS],
      [\ORIG :: \PENDING, \ACCEPTED, \UPDATECOU(\MANAGERS,\PUK,\TRUE), \CONTRACTORS, \TIME]}
  }
\end{mathpar}
% \begin{equation}{}
