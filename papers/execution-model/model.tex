...
\begin{align*}
  ...
  \STATUS & ::= \STATUSPENDING \mid \STATUSINCLUDING (\dots) \mid \STATUSTIMEOUT \\
	\EXPR & :: =  \CONSTANT \mid \STATUS \mid \VARIABLE \mid \lambda \VARIABLE. \EXPR\ 
...
\begin{mathpar}
  \inferrule{
    ...
    \NodeTrans\\ [\epsilon[\FAIL] ::\EXPRS, \ACCOUNTS, \OPERATIONS]  \| [\PENDING, \ACCEPTED,  \MANAGERS, \CONTRACTORS, \TIME]}
\end{mathpar}
~\\
~\\
...
\begin{mathpar}
  \inferrule{ 
    \NEG\ \CHECKEXIST (\ADDR, \PENDING, \ACCEPTED)
