...
\begin{mathpar}
  ...
  \inferrule{\TYPE= ???}{\JTypeExpr\TEnv\CODE{\TCODE\ \TYPE}}
  ...
  \inferrule{
    \JTypeExpr\TEnv{\EXPR_1}\TTEZ \\
    \JTypeExpr\TEnv{\EXPR_2}\TPUK \\
    \JTypeExpr\TEnv{\EXPR_3}{\TCODE\ \TYPE} \\
    \JTypeExpr\TEnv{\EXPR_4}\TYPE \\ % really \TSTRING \\
    \JTypeExpr\TEnv{\EXPR_5}\TTEZ
  }{
    \JTypeExpr\TEnv{\ORIGINATE{\EXPR_1}{\EXPR_2}{\EXPR_3}{\EXPR_4}{\EXPR_5}}\TPUH
  }
\end{mathpar}
