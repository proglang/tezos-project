...
\begin{mathpar}
  \inferrule{
    ...
    \OPH = \GENERATEOPH (\PUK, \PUK', \NTEZ, \MTEZ)
  }{
   { [\ACCOUNTS, \OP :: \OPERATIONS, \CONTRACTS] \| [\PENDING,
...
\begin{mathpar}
  \inferrule[Block-Accept]{
    ...
    {[\Angle{\OP,\OPH, \TIME} :: \PENDING, \ACCEPTED, \MANAGERS,
      \CONTRACTORS, \TIME']}
    \BlockTrans 
    {[\PENDING, \Angle{\OP,\OPH,\TIME'} :: \ACCEPTED, \MANAGERS,
      \CONTRACTORS, \TIME'+1]}
  }
\end{mathpar}
Rule 7 [timeout]:
...
\begin{mathpar}
  \inferrule[Block-Originate]{
    ...
    \ORIG = \ORIGINATE\ID\NTEZ\PUK\CODE\STRING\MTEZ 
  }{
    \Angle{[
      \ACCOUNTS, \ORIG :: \OPERATIONS, \CONTRACTS
      ], [\PENDING, \ACCEPTED, \MANAGERS, \CONTRACTORS, \TIME]} \to \\
    \Angle{[\ACCOUNTS, \OPERATIONS, \CONTRACTS],
      [\Angle{\ORIG,\TIME} :: \PENDING, \ACCEPTED, \UPDATECOU(\MANAGERS,\PUK,\TRUE), \CONTRACTORS, \TIME]}
  }
\end{mathpar}
% \begin{equation}{}
...
\begin{mathpar}
  \inferrule[Block-Accept]{
    ...
    \Angle{[\ACCOUNTS, \OPERATIONS, \CONTRACTS],
      [\Angle{\OP,\TIME} :: \PENDING, \ACCEPTED, \MANAGERS, \CONTRACTORS, \TIME']}
    \SystemTrans \\
    \langle
      [\ACCOUNTS, \OPERATIONS, \Angle{\ID, \OPH, \CODE} ::\CONTRACTS],
      \\
      [\PENDING, \Angle{\OP, \TIME'} :: \ACCEPTED, \UPDATESUCC
...
\begin{mathpar}
  \inferrule[Block-Timeout]{
    ...
    %\Angle{[\ACCOUNTS, \OPERATIONS, \CONTRACTS],
      [\Angle{\OP,\TIME} :: \PENDING, \ACCEPTED, \MANAGERS,
      \CONTRACTORS, \TIME']
    %}
    \BlockTrans
    % \Angle{[\ACCOUNTS, \OPERATIONS, \CONTRACTS],
