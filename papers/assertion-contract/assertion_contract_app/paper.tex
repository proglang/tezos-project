...
\toprule
Parameter Size & Line 1 Gas Consumption & Line 2 Gas Consumption & Difference \\
\midrule
...
\begin{tikzpicture}
\begin{axis}[
    title={Difference in Gas Consumption},
    xlabel={Parameter Size},
    ylabel={Difference in Gas Consumption},
    legend pos=north west,
    grid=major,
    width=10cm,
    height=6cm
